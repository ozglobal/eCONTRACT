...
@XmlRootElement(name = "onlinecontract_new")
public class OnlinecontractNew {
    ...
    @XmlElementRef(name = "prod_no", namespace = "http://websvc.unitel.mn", type = JAXBElement.class, required = false)
    protected JAXBElement<String> prodNo;
    @XmlElementRef(name = "contractType", namespace = "http://websvc.unitel.mn", type = JAXBElement.class, required = false)
